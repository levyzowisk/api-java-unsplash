...
public class CollectionController {
    ...
    public ResponseEntity<Void> deletePhotoFromCollection (@PathVariable("collectionId") UUID collectionId, @PathVariable("photoId") UUID photoId) {
        collectionService.deleteCollectionImage(collectionId, photoId);
        return ResponseEntity.noContent().build();
    }
